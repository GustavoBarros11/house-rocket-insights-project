...
After the analysis, among the 21,435 properties available for purchase in the King County region, **3808 were suggested for purchase** and detailed in the Dashboard (report) for the "CEO".

If the recommended properties are purchased, the initial investment expected is $11.5 billion dollars. Upon resale of all properties, a total of $13.5 billion will be raised and the total expected profit is **$1.97 billion**, dollar, totaling a **17% return on the capital initially invested**.
